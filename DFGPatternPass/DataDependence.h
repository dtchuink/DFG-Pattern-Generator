...
class DataDependence {
  public:
    ...
    void getDataDependencies(Function &F, MemoryDependenceResults &MDA, AliasAnalysis &AA);
  ...
  private:
    ...
    void processDepResult(Function &FI, Instruction *inst, MemoryDependenceResults &MDA, AliasAnalysis &AA);
